...
from home.models import CustomUser, WorkEntry
...
print("Count of work entries:", WorkEntry.objects.count())

if "pagination" in html:
    print("Found pagination block")
    if "start_date=2024-01-01" in html:
        ...
        print("HTML Snippet:", html[html.find('pagination'):html.find('</nav>')+6])
else:
    print("FAIL: Pagination block NOT rendered. Not enough items?")
